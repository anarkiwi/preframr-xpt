...
- Anchor validation (back `design/landed/trajectory_anchoring.md`): `gate_anchor_probe.py`,
...
- Predict-host (backs `design/performance/orin_inference_optimization_design.md`): `perf_probe.py`.
