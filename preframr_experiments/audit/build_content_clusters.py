#!/usr/bin/env python3
"""Offline content-tier cluster index builder for the cluster-conditional content head (Phase 0). See design/refuted/cluster_conditional_content_head_design.md."""
